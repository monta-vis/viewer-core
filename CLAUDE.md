...
- **`packages/viewer-core/`** — `@monta-vis/viewer-core` — shared React component library (published to GitHub Packages)
...
- Add app-specific logic (routes, IPC, DB) to viewer-core
