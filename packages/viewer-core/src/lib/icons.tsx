/**
 * Centralized domain icon map.
 *
 * Change the icon for a domain concept (Part, Tool, Assembly) in ONE place
 * and every component picks it up automatically.
 *
 * Generic UI icons (X, Check, Plus, ChevronDown, …) stay as direct
 * lucide-react imports — they're standard and won't change.
 */
import type { SVGProps } from 'react';

/** Screw icon (inlined from game-icons.net — CC BY 3.0). */
...
export { Wrench as ToolIcon } from 'lucide-react';
export { Package as AssemblyIcon } from 'lucide-react';
